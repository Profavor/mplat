...
insert into menu (id, createddate, creator, lastupdated, updator, disp_seq,  path, dic_id, parent_id) values (uuid(), now(), 'f0193abf528db47301528db547520000', now(), 'f0193abf528db47301528db547520000', '2', '/dashboard/dashboard1', 'SYS0002', '172dfd3e-3746-11e8-9f57-5989a59d25e0');
insert into menu (id, createddate, creator, lastupdated, updator, disp_seq,  path, dic_id, parent_id) values (uuid(), now(), 'f0193abf528db47301528db547520000', now(), 'f0193abf528db47301528db547520000', '2', '/dashboard/dashboard1', 'SYS0002', '172dfd3e-3746-11e8-9f57-5989a59d25e0');
